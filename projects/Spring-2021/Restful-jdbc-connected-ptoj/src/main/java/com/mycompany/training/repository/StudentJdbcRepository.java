...
public class StudentJdbcRepository {
	...
	public int isStudentExists(int id) {
		
		int count =  jdbcTemplate.queryForObject("select count(*) from student where id = ?", new Object[]{id},Integer.class);
		return count;		 
	...
	public int insert(Student student) {
		...
		System.out.println("======== Inside final insert method ==========");
